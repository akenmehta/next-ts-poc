import  { React, useEffect, useRef, useState } from "@shared/vendor";

/*
 * Mostly copied from https://github.com/metabase/sso-examples/blob/master/app-embed-example/src/MetabaseAppEmbed.js
 */
const MetabaseAppEmbed = ({
  ...
  if (location.current == null) {
    ...
    // TODO: cole i cant figure this out... Code reaches here but nothing happens. Asked support
